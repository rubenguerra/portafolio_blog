...
// Opciones para crear animaciones comunes
ScrollReveal({
    reset: true,
    distance: '60px',
    duration: 2500,
...
ScrollReveal().reveal('footer .group', {delay: 400, origin: 'top', interval: 100});
